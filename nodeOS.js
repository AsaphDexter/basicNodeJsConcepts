...
In this example, we are including some basic functions. 
Create a file having the following code:*/
...
In this example, we are including remaining functions. 
Create a file named os_example2.js having the following code:*/
